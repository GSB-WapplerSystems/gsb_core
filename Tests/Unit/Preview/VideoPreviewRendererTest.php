...
class VideoPreviewRendererTest extends AbstractPreviewRendererTest
{
    ...
    public function testRenderPageModulePreviewContent()
    {
        ...
        $this->assertEquals('<div class="text-left">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et</div>',$result);
        $item = \Codeception\Stub::make(VideoPreviewRenderer::class,
            [
