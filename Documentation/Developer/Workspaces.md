...
The Default Workspace Configuration get imported on every deployment. The Configuration is located in the file `Configuration/Workspaces/BaseWorflow.yaml`.
