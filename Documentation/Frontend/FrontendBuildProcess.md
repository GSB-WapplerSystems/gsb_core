...
- Node Version 18 LTS is used for the work [nodejs.org](https://nodejs.org/en/)
- For development the latest bootstrap library is used [getbootstrap.com](https://getbootstrap.com/)
