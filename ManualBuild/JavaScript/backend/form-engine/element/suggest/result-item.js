 ...
 */
var __decorate=this&&this.__decorate||function(e,t,n,o){var i,r=arguments.length,s=r<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,n):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,n,o);else for(var l=e.length-1;l>=0;l--)(i=e[l])&&(s=(r<3?i(s):r>3?i(t,n,s):i(t,n))||s);return r>3&&s&&Object.defineProperty(t,n,s),s};import{customElement,property}from"lit/decorators";import{html,LitElement}from"lit";import"@typo3/backend/element/icon-element";let ResultItem=class extends LitElement{connectedCallback(){super.connectedCallback(),this.addEventListener("blur",this.onBlur),this.addEventListener("click",this.onClick),this.addEventListener("keyup",this.onKeyUp)}disconnectedCallback(){this.removeEventListener("blur",this.onBlur),this.removeEventListener("click",this.onClick),this.removeEventListener("keyup",this.onKeyUp),super.disconnectedCallback()}createRenderRoot(){return this}render(){return html`
