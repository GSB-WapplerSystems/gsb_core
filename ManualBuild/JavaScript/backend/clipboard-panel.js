 ...
 */
var ClipboardPanel_1,CopyMode,__decorate=this&&this.__decorate||function(t,e,o,a){var i,n=arguments.length,l=n<3?e:null===a?a=Object.getOwnPropertyDescriptor(e,o):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(t,e,o,a);else for(var r=t.length-1;r>=0;r--)(i=t[r])&&(l=(n<3?i(l):n>3?i(e,o,l):i(e,o))||l);return n>3&&l&&Object.defineProperty(e,o,l),l};import{html,LitElement,nothing}from"lit";import{customElement,property}from"lit/decorators";import{until}from"lit/directives/until";import{unsafeHTML}from"lit/directives/unsafe-html";import{classMap}from"lit/directives/class-map";import AjaxRequest from"@typo3/core/ajax/ajax-request";import Notification from"@typo3/backend/notification";import"@typo3/backend/element/spinner-element";import"@typo3/backend/element/icon-element";!function(t){t.cut="cut",t.copy="copy"}(CopyMode||(CopyMode={}));let ClipboardPanel=ClipboardPanel_1=class extends LitElement{constructor(){super(...arguments),this.returnUrl="",this.table=""}static renderLoader(){return html`
