 ...
 */
import AjaxRequest from"@typo3/core/ajax/ajax-request";import ClientStorage from"./storage/client";import{Sizes,States,MarkupIdentifiers}from"./enum/icon-types";import{css,unsafeCSS}from"lit";export class IconStyles{static getStyles(){return[css`
        :host {
