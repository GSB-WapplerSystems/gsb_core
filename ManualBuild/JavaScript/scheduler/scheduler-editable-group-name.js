 ...
 */
var EditableGroupName_1,__decorate=this&&this.__decorate||function(t,e,o,i){var r,a=arguments.length,n=a<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,o,i);else for(var s=t.length-1;s>=0;s--)(r=t[s])&&(n=(a<3?r(n):a>3?r(e,o,n):r(e,o))||n);return a>3&&n&&Object.defineProperty(e,o,n),n};import{lll}from"@typo3/core/lit-helper";import{html,css,LitElement,nothing}from"lit";import{customElement,property,state}from"lit/decorators";import"../backend/element/icon-element";import AjaxRequest from"@typo3/core/ajax/ajax-request";import Notification from"@typo3/backend/notification";let EditableGroupName=EditableGroupName_1=class extends LitElement{constructor(){super(...arguments),this.groupName="",this.groupId=0,this.editable=!1,this._isEditing=!1,this._isSubmitting=!1}static updateInputSize(t){const e=t;e.value.length<10?e.size=10:e.size=e.value.length+2}async startEditing(){this.isEditable()&&(this._isEditing=!0,await this.updateComplete,this.shadowRoot.querySelector("input")?.focus())}render(){if(""===this.groupName)return nothing;if(!this.isEditable())return html`
