 ...
 */
import Modal from"@typo3/backend/modal";import{html}from"lit";import AjaxRequest from"@typo3/core/ajax/ajax-request";import Notification from"@typo3/backend/notification";import{lll}from"@typo3/core/lit-helper";class SchedulerAddGroups{constructor(){this.selector=".t3js-create-group",this.initialize()}initialize(){const e=document.querySelector(this.selector);e&&e.addEventListener("click",(e=>{e.preventDefault();const t=html`
