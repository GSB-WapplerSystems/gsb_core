...
- Informationen zu den [allgemeinen TYPO3 Systemvoraussetzungen](https://get.typo3.org/version/12#system-requirements)
...
Eine vollständige Liste der vorgeschlagenen neuen Funktionen (und bekannten Probleme) findest du in unserem [Jira](https://jira.powerofone.de/jira/secure/RapidBoard.jspa?rapidView=2924&projectKey=ITZBUNDPHP&view=planning&issueLimit=100).
...
Du kannst jederzeit 
- [Fehler melden](https://jira.powerofone.de/jira/secure/CreateIssue!default.jspa?pid=21636&issuetype=1)
