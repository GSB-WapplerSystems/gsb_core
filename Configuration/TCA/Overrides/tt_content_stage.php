...
$tempStageColumns = [
    ...
    'tx_stage_salutation' =>
        [
                ...
                [
                    'items' =>
                        [
                            0 =>
                                [
                                    0 => 'LLL:EXT:gsb_template/Resources/Private/Language/locallang_db.xlf:stage.tx_stage_salutation.I.1',
                                ],
                        ],
                    'renderType' => 'checkboxToggle',
                    'type' => 'check',
            ...
            'exclude' => '1',
            'label' => 'LLL:EXT:gsb_template/Resources/Private/Language/locallang_db.xlf:stage.tx_stage_salutation',
        ],
];
    ...
    'stage' =>
        [
            ...
            --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:general,
                ...
                --palette--;;headerstage_config,tx_stage_salutation,bodytext,
