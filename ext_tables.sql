...
(
	...
	main_category_overwrite        tinytext,
	main_category_overwrite_toggle tinyint(4)       DEFAULT '0' NOT NULL,
	...
	tx_video_a11y_videodescription tinytext,
	tx_video_a11y_audiodescription tinytext,
	tx_video_a11y_audio_voiceover  int(11) unsigned DEFAULT '0' NOT NULL,
	...
	gallery_columns                int(11) unsigned DEFAULT '0' NOT NULL,
	tx_link                        tinytext,
