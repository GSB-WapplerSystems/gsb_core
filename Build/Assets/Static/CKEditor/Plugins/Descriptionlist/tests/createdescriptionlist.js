...
test('on four not fully selected paragraphs', function () {
    ...
    tests.editor.execCommand('descriptionList');
    assert.areSame(
        '<p>x</p><dl><dt>p[1</dt><dd>p2</dd><dt>p3</dt><dd>p]4</dd></dl><p>x</p>',
...
test('on a single list item between other items', function () {
    ...
    tests.editor.execCommand('descriptionList');
    assert.areSame(
        '<ul><li>x</li></ul><dl><dt>[]foo</dt></dl><ul><li>y</li></ul>',
        tests.getHtmlWithSelection()
    );
});
...
test('on two list items', function () {
    ...
    tests.editor.execCommand('descriptionList');
    assert.areSame(
        '<p>x</p><dl><dt>[foo</dt><dd>bar]</dd></dl><p>y</p>',
        tests.getHtmlWithSelection()
    );
});
...
test('on two list items between other items', function () {
    ...
    tests.editor.execCommand('descriptionList');
    assert.areSame(
        '<ul><li>x</li></ul><dl><dt>[foo</dt><dd>bar]</dd></dl><ul><li>y</li></ul>',
        tests.getHtmlWithSelection()
    );
});
...
test('on list items between blocks', function () {
    ...
    tests.editor.execCommand('descriptionList');
    assert.areSame(
        '<p>x</p><dl><dt>[p1</dt><dd>l1</dd><dt>l2</dt><dd>p2]</dd></dl><p>y</p>',
        tests.getHtmlWithSelection()
    );
});
...
test('on a paragraph between lists', function () {
    ...
    tests.editor.execCommand('descriptionList');
    assert.areSame(
        '<ul><li>x</li></ul><dl><dt>f[oo</dt><dd>bar</dd><dt>bo]m</dt></dl><ol><li>x</li></ol>',
        tests.getHtmlWithSelection()
    );
});
...
test('on list after paragraph', function () {
    ...
    tests.editor.execCommand('descriptionList');
    assert.areSame(
        '<p>x</p><dl><dt>[foo</dt><dd>bar</dd><dt>bom]</dt></dl><ul><li>bim</li></ul><p>x</p>',
        tests.getHtmlWithSelection()
    );
});
...
test('list preceded by paragraphs', function () {
    ...
    tests.editor.execCommand('descriptionList');
    assert.areSame(
        '<p>x</p><dl class="a"><dt>[foo</dt><dd>bar</dd><dt>bom]</dt><dt>x</dt></dl>',
        tests.getHtmlWithSelection()
    );
});
...
test('list preceded by paragraphs, selection ending in list', function () {
    ...
    tests.editor.execCommand('descriptionList');
    assert.areSame(
        '<p>x</p><dl class="a"><dt>[foo</dt><dd>bar</dd><dt>bom</dt><dt>x]</dt><dd>y</dd></dl>',
        tests.getHtmlWithSelection()
    );
});
...
test('list preceded by paragraphs, selection ending in list, second list included', function () {
    ...
    tests.editor.execCommand('descriptionList');
    assert.areSame(
        '<p>x</p><dl class="a"><dt>[foo</dt><dt>bar</dt><dt>x]</dt><dd>y</dd></dl>',
        tests.getHtmlWithSelection()
    );
});
...
test('list preceded and followed by paragraphs', function () {
    ...
    tests.editor.execCommand('descriptionList');
    assert.areSame(
        '<p>x</p><dl><dt>[foo</dt><dt>x</dt><dd>y</dd><dt>bar]</dt></dl><p>x</p>',
        tests.getHtmlWithSelection()
    );
});
...
test('paragraph between lists', function () {
    ...
    tests.editor.execCommand('descriptionList');
    assert.areSame(
        '<dl class="b"><dt>x</dt><dd>[]foo</dd><dt>y</dt></dl>',
        tests.getHtmlWithSelection()
    );
});
...
test('paragraphs between lists', function () {
    ...
    tests.editor.execCommand('descriptionList');
    assert.areSame(
        '<dl class="b"><dt>x</dt><dd>[foo</dd><dt>bar]</dt><dt>y</dt></dl>',
        tests.getHtmlWithSelection()
    );
});
...
test('paragraph between lists, selection ending in following list', function () {
    ...
    tests.editor.execCommand('descriptionList');
    assert.areSame(
        '<dl class="b"><dt>x</dt><dd>[foo</dd><dd>bar]</dd><dt>y</dt></dl>',
        tests.getHtmlWithSelection()
    );
});