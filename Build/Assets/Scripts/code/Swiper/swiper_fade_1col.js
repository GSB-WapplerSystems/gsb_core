...
if (document.querySelector('.swiper-fade-col-12')) {
  const SwiperFade1Col = function () {
    const customSwiper = document.querySelectorAll('.swiper-fade-col-12')
    let i
    for (i = 0; i < customSwiper.length; i++) {
      customSwiper[i].classList.add('swiper-fade-col-12-' + i)
      /* eslint-disable no-unused-vars */
      const swiperFadeCol12 = new Swiper('.swiper-fade-col-12-' + i, {
        slidesPerView: 1,
        slidesPerGroup: 1,
        spaceBetween: 0,
        watchOverflow: true,
